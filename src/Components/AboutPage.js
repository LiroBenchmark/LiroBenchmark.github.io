...
const AboutPage = (props) => {
  return (
    <>
      <h1>Who are we?</h1>
      <p>
        We are a group of Romanians with expertise in Machine Learning, NLP, linguistics, and data privacy. Our goal is
        to accelerate progress in AI research on Romanian language tasks.
      </p>
      <h1>
      ...
      <p>
        ...
        {datasets_info.datasets.length} datasets: {tasks_info.tasks.length} existing in the literature, {0} newly
        created through our team’s efforts.
      </p>
      <h2>Leaderboard</h2>
      <p>
        LiRo keeps track of performance of different published models on the datasets and tasks listed above. This
        allows easy comparison of different models and monitoring progress on these tasks and datasets over time.
      </p>
      <h2>Starter code</h2>
      <p>
      ...
      <ul>
        ...
        <li>Adriana Stan, Assistant Professor (Technical University of Cluj-Napoca)</li>
